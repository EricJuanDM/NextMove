...
def venda_porta():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            conn.commit()
            return render_template('portaria/venda_porta.html', mensagem_sucesso=f"Venda registrada! {nome_comprador} já está com check-in feito.")
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if usuario_existente:
                ...
                nome_banco = usuario_existente[1]
